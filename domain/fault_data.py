...
This module provides immutable containers for storing fault current values,
ensuring data integrity throughout the analysis pipeline.
"""
...
class FaultCurrents:
    ...
    of fault study results. All values are in Amperes (primary).
    ...
    def max_phase(self) -> float:
        """Maximum of three-phase and two-phase fault currents."""
